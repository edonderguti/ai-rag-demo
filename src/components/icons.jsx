...
export const AIRobotIcon = ({ size = 16 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 32 32"
    ...
    >
      <path
        fill="black"
        d="M29.24 15.48c-.27-.65-.85-.81-1.24-.84V10.67A2.67 2.67 0 0 0 25.33 8h-8V6.15c.41-.37.67-.89.67-1.48a2 2 0 0 0-4 0c0 .59.26 1.11.67 1.48V8h-8A2.67 2.67 0 0 0 4 10.67v4l-.11.01A1.33 1.33 0 0 0 2.67 16v2.67a1.33 1.33 0 0 0 1.33 1.33H4v6.67A2.67 2.67 0 0 0 6.67 29h18.66a2.67 2.67 0 0 0 2.67-2.67V20a1.33 1.33 0 0 0 1.33-1.33v-2.58c0-.2-.03-.41-.09-.61zM6.67 26.67V10.67h18.66v5.32L25.33 16v2.67l.002.006.001 7.994H6.67z"
      />
      <ellipse cx="11.33" cy="16" rx="2" ry="2.67" fill="black" />
      <ellipse cx="20.67" cy="16" rx="2" ry="2.67" fill="black" />
      <path d="M10.67 21.33h10.66v2.67H10.67z" fill="black" />
    </svg>
  );
};
...
export const CheckCirclFillIcon = ({ size = 16 }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
